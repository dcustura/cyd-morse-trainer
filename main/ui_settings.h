 ...
 * a confirmation popup, and Save/Back. Widget changes only take effect when
 * Save is pressed (a known, accepted simplification: navigating Back first
 * discards edits). Must be called while holding the LVGL lock
 * (lvgl_port_lock).
 */
